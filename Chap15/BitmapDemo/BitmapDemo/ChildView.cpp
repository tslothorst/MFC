...
BEGIN_MESSAGE_MAP(CChildView, CWnd)
	...
	ON_WM_CREATE()
	ON_WM_ERASEBKGND()
	ON_COMMAND(ID_OPTIONS_DRAW_OPAQUE, &CChildView::OnOptionsDrawOpaque)
	ON_COMMAND(ID_OPTIONS_DRAW_TRANSPARENT, &CChildView::OnOptionsDrawTransparent)
	ON_UPDATE_COMMAND_UI(ID_OPTIONS_DRAW_OPAQUE, &CChildView::OnUpdateOptionsDrawOpaque)
	ON_UPDATE_COMMAND_UI(ID_OPTIONS_DRAW_TRANSPARENT, &CChildView::OnUpdateOptionsDrawTransparent)
END_MESSAGE_MAP()
