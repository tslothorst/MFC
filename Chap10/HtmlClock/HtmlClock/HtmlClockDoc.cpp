...
CHtmlClockDoc::CHtmlClockDoc() noexcept
{
...
void CHtmlClockDoc::OnDrawThumbnail(CDC& dc, LPRECT lprcBounds)
{
...
void CHtmlClockDoc::InitializeSearchContent()
{
...
void CHtmlClockDoc::SetSearchContent(const CString& value)
{
	if (value.IsEmpty())
	{
