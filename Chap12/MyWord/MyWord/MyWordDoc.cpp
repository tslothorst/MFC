...
BEGIN_MESSAGE_MAP(CMyWordDoc, CRichEditDoc)
	...
	ON_UPDATE_COMMAND_UI(ID_OLE_VERB_POPUP, &CMyWordDoc::OnUpdateObjectVerbPopup)
...
CMyWordDoc::CMyWordDoc() noexcept
{
...
{
	return new CMyWordCntrItem(preo, const_cast<CMyWordDoc*>(this));
}
...
void CMyWordDoc::OnDrawThumbnail(CDC& dc, LPRECT lprcBounds)
{
...
void CMyWordDoc::InitializeSearchContent()
{
...
void CMyWordDoc::SetSearchContent(const CString& value)
{
	if (value.IsEmpty())
	{
